...
@section('title', \MySara\Common\Libraries\MetaInfo::getInstance($product)->getTitle())
@section('description', \MySara\Common\Libraries\MetaInfo::getInstance($product)->getDescription())
@section('keywords', \MySara\Common\Libraries\MetaInfo::getInstance($product)->getKeywords())
