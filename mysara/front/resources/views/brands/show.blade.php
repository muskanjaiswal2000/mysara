...
@section('title', \MySara\Common\Libraries\MetaInfo::getInstance($brand)->getTitle())
@section('description', \MySara\Common\Libraries\MetaInfo::getInstance($brand)->getDescription())
@section('keywords', \MySara\Common\Libraries\MetaInfo::getInstance($brand)->getKeywords())
