...
@section('title', \MySara\Common\Libraries\MetaInfo::getInstance($article)->getTitle())
@section('description', \MySara\Common\Libraries\MetaInfo::getInstance($article)->getDescription())
@section('keywords', \MySara\Common\Libraries\MetaInfo::getInstance($article)->getKeywords())
