...
@section('title', \MySara\Common\Libraries\MetaInfo::getInstance($category)->getTitle())
@section('description', \MySara\Common\Libraries\MetaInfo::getInstance($category)->getDescription())
@section('keywords', \MySara\Common\Libraries\MetaInfo::getInstance($category)->getKeywords())
