...
use MySara\Front\Middleware\CustomerAuthentication;
use MySara\Front\Middleware\GlobalFrontData;
use MySara\Front\Middleware\MaintenanceMode;
use MySara\Front\Middleware\SetFrontLocale;
...
class FrontServiceProvider extends ServiceProvider
{
     ...
     * php artisan vendor:publish --provider='MySara\Front\FrontServiceProvider' --tag=views
     *
     * @return void
     */
