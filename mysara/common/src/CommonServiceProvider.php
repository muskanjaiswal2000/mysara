...
namespace MySara\Common;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\ServiceProvider;
use MySara\Common\Components\Base;
use MySara\Common\Components\Forms;
use MySara\Common\Console\Commands;
...
class CommonServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom($this->basePath.'config/mysara.php', 'mysara');
        if (installed()) {
