...
use MySara\Common\Handlers\TranslationHandler;
use MySara\Common\Models\Category;
use MySara\Common\Models\Product;
use MySara\Common\Repositories\Product\BundleRepo;
use MySara\Common\Repositories\Product\OptionValueRepo;
use MySara\Common\Repositories\Product\RelationRepo;
use MySara\Common\Repositories\Product\VariantRepo;
use Throwable;
...
class ProductRepo extends BaseRepo
{
    ...
    public function builder(array $filters = []): Builder
    {
        ...
        $queryBuilder = new \MySara\Common\Services\ProductQueryBuilder;
