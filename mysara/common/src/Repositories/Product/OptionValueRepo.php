...
use MySara\Common\Models\Product\OptionValue;
...
class OptionValueRepo extends BaseRepo
{
    ...
    public function createProductOptionValues(int $productId, $optionValues): bool
    {
        ...
        \MySara\Common\Models\Product\Option::where('product_id', $productId)->delete();
        ...
        foreach ($optionValues as $optionConfig) {
            ...
            \MySara\Common\Models\Product\Option::create([
