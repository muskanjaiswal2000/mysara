...
namespace MySara\Common\Repositories\Customer;

use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pagination\LengthAwarePaginator;
use MySara\Common\Models\Customer\Transaction;
use MySara\Common\Models\Customer\Withdrawal;
...
class WithdrawalRepo extends BaseRepo
{
    ...
    private function createWithdrawTransaction(Withdrawal $withdrawal): void
    {
        ...
        \MySara\Common\Repositories\Customer\TransactionRepo::getInstance()->create($transactionData);
    }
}
