...
use MySara\Common\Models\OrderReturn\History;
...
class OrderReturn extends BaseModel
{
    ...
    {
        return [
            \MySara\Common\Services\ReturnStateService::CREATED   => 'secondary',
            \MySara\Common\Services\ReturnStateService::PENDING   => 'warning',
            \MySara\Common\Services\ReturnStateService::REFUNDED  => 'info',
            \MySara\Common\Services\ReturnStateService::RETURNED  => 'success',
            \MySara\Common\Services\ReturnStateService::CANCELLED => 'danger',
        ];
    }
}
