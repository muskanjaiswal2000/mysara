...
use MySara\Common\Models\Customer\Favorite;
use MySara\Common\Models\Order\Item;
use MySara\Common\Models\Product\Relation;
use MySara\Common\Models\Product\Sku;
use MySara\Common\Traits\HasPackageFactory;
use MySara\Common\Traits\Replicate;
...
class Product extends BaseModel
{
    ...
    {
        return $this->hasMany(\MySara\Common\Models\Product\Attribute::class, 'product_id');
    }
    ...
    {
        return $this->hasMany(\MySara\Common\Models\Product\Option::class, 'product_id', 'id');
    }
    ...
    {
        return $this->hasMany(\MySara\Common\Models\Product\OptionValue::class, 'product_id', 'id');
    }
