...
Route::middleware(['admin_auth:admin'])
    ->group(function () {
        ...
        Route::get('/file_manager', [MySara\RestAPI\PanelApiControllers\FileManagerController::class, 'index'])->name('file_manager.index');
        Route::get('/file_manager/iframe', [MySara\RestAPI\PanelApiControllers\FileManagerController::class, 'iframe'])->name('file_manager.iframe');
    });
