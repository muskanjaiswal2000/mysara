...
@section('content')
  <div id="app">
        ...
        <el-row type="flex" justify="space-between" align="middle">
          <el-col :span="12">
            <el-button-group>
              ...
              <el-button size="small" :type="isMultiSelectMode ? 'primary' : 'default'" @click="toggleMultiSelectMode">
                <i class="el-icon-check"></i> Multi-select
              </el-button>
          ...
          <el-col :span="12" style="text-align: right">
            ...
            <el-select v-model="sortField" size="small" style="width:110px;margin-left:10px;" @change="onSortChange">
              <el-option label="By Time" value="created"></el-option>
    ...
    <!-- Upload Files Dialog -->
    <el-dialog title="Upload Files" :visible.sync="uploadDialog.visible" width="500px" @open="onUploadDialogOpen">
      <el-upload class="file-uploader" drag multiple :action="uploadUrl" :headers="uploadHeaders"
        ...
        <div class="el-upload__tip" slot="tip">Supported file types: jpg, jpeg, png, gif, webp, mp4</div>
        <div class="el-upload__tip" slot="tip">Server max upload file size: {{ $uploadMaxFileSize ?? 'Unknown' }}</div>
    ...
    <el-dialog title="Rename" :visible.sync="renameDialog.visible" custom-class="rename-dialog" width="500px">
      <el-form :model="renameDialog.form" label-width="100px">
        <el-form-item label="File Name">
          <el-input v-model="renameDialog.form.newName" placeholder="Please enter a new name">
    ...
    <el-dialog title="Rename Folder" :visible.sync="folderRenameDialog.visible" width="400px">
      <el-form :model="folderRenameDialog.form" label-width="80px">
        <el-form-item label="Folder Name">
          <el-input v-model="folderRenameDialog.form.newName" placeholder="Please enter a new name"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer">
              ...
              <div v-if="storageConfig.driver === 'oss'">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="ossEndpoint" v-model="storageConfig.endpoint"
                    placeholder="例如: https://MySara.oss-cn-hangzhou.aliyuncs.com">
                </div>
      ...
      methods: {
        ...
        submitCreateFolder() {
          ...
          http.post('file_manager/directories', {
            ...
            this.$message.error('Create failed: ' + err.message);
          });
        },
        deleteFiles() {
          if (!this.selectedFiles.length) return;

          this.$confirm('Confirm delete selected files?', 'Confirm', {
