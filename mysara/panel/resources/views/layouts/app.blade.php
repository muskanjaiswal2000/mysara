...
<head>
  ...
  <title>@yield('title'){{ View::hasSection('title') ? ' - ' : '' }}MySara</title>
  <meta name="keywords" content="@yield('keywords', 'MySara, 创新, 开源, CMS, Laravel 11, 多语言, 多货币, Hook, 插件架构, 灵活, 强大')">
  <meta name="generator" content="MySara {{ MySara_version() }}">
  <meta name="asset" content="{{ asset('/') }}">
  <meta name="description" content="@yield('description', 'MySara')">
    ...
    <div id="content">
      ...
      <div class="container-fluid p-0 mt-2">
        ...
        <p class="text-center text-secondary mt-5">
          {!! MySara_brand_link() !!}
          {{ MySara_version() }} &copy; {{ date('Y') }} All Rights Reserved
        </p>
      </div>
    </div>
  </div>
