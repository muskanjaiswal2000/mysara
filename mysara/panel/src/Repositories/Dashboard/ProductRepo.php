...
class ProductRepo extends BaseRepo
{
    ...
    {
        $products = \MySara\Common\Repositories\ProductRepo::getInstance()->getBestSellerProducts(8);
    ...
    {
        $products = \MySara\Common\Repositories\ProductRepo::getInstance()->getBestSellerProducts();
