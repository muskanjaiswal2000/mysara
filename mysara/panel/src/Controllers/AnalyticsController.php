...
use Exception;
use MySara\Panel\Repositories\Analytics\CustomerRepo;
use MySara\Panel\Repositories\Analytics\ProductRepo;
...
class AnalyticsController extends BaseController
{
    ...
    public function order(): mixed
    {
        $data = [
            ...
            'order_total_latest_month'    => \MySara\Panel\Repositories\Analytics\OrderRepo::getInstance()->getOrderTotalLatestMonth(),
            'order_total_latest_week'     => \MySara\Panel\Repositories\Analytics\OrderRepo::getInstance()->getOrderTotalLatestWeek(),
            'top_sale_products'           => \MySara\Panel\Repositories\Dashboard\ProductRepo::getInstance()->getTopSaleProducts(),
        ];
