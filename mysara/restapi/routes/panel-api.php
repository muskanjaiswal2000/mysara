...
use MySara\RestAPI\PanelApiControllers;
...
Route::middleware($middlewares)->group(function () {
    ...
    Route::get('/file_manager/storage_config', [\MySara\RestAPI\PanelApiControllers\FileManagerController::class, 'getStorageConfig']);
    Route::post('/file_manager/storage_config', [\MySara\RestAPI\PanelApiControllers\FileManagerController::class, 'saveStorageConfig']);
});
