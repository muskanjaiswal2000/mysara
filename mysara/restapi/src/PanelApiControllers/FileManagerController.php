...
use MySara\RestAPI\Requests\FileRequest;
use MySara\RestAPI\Services\FileManagerInterface;
use MySara\RestAPI\Services\FileManagerService;
use MySara\RestAPI\Services\OSSService;
...
class FileManagerController extends BaseController
{
    ...
    public function saveStorageConfig(Request $request): mixed
    {
        try {
            ...
            $settingRepo = \MySara\Common\Repositories\SettingRepo::getInstance();
