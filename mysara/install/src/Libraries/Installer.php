...
namespace MySara\Install\Libraries;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Str;
use MySara\Install\Libraries\Database\MySQLDatabase;
use MySara\Install\Libraries\Database\SQLiteDatabase;
use MySara\Install\Libraries\Environment\EnvironmentChecker;

/**
 * Installer class
 *
 * Handles the installation process of MySara
 */
class Installer
{
