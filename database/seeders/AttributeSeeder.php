...
use MySara\Common\Models\Attribute\Group as AttributeGroup;
use MySara\Common\Models\Attribute\Group\Translation as AttributeGroupTranslation;
use MySara\Common\Models\Attribute\Translation as AttributeTranslation;
use MySara\Common\Models\Attribute\Value as AttributeValue;
use MySara\Common\Models\Attribute\Value\Translation as AttributeValueTranslation;
use MySara\Common\Models\Product\Attribute as ProductAttribute;
...
class AttributeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $items = array_values(array_filter($this->getGroupTranslations(), function ($item) {
        ...
        $items = array_values(array_filter($this->getAttributeTranslations(), function ($item) {
            return ($item['locale'] ?? '') === 'en';
        }));
        ...
        $items = array_values(array_filter($this->getAttributeValueTranslations(), function ($item) {
            return ($item['locale'] ?? '') === 'en';
        }));
