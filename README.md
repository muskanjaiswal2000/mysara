<p align="center">
    <a href="https://www.mysara.com"><img src="https://www.mysara.com/images/logo.png" alt="Total Downloads"></a>
</p>

---

<p align="center">
    <a href="https://www.mysara.com"><img src="https://img.shields.io/badge/License-OSL%203.0-green.svg" alt="Total Downloads"></a>
...
# MySara
MySara - Innovative Open Source E-commerce System.

MySara is an Open Source eCommerce System based on Laravel 12, supporting multiple languages, multiple currencies, integrated with OpenAI, and featuring plugin mechanisms and theme template development for enhanced user experience and system extensibility.
...
## Documentation
- https://docs.mysara.cn/en
- http://front-api.mysara.cn
- http://panel-api.mysara.cn

## Demo Site
- Frontend: https://demo.mysara.cn
- Backend: https://demo.mysara.cn/panel
- Account: admin@mysara.com
- Password: 123456

### Frontend Screenshot
<p align="center">
    <a href="https://www.mysara.cn"  target="_blank">
        <img src="https://www.mysara.cn/images/readme/front.jpg?v"  alt="Front">
    </a>
</p>

### Backend Screenshot
<p align="center">
    <a href="https://www.mysara.com"  target="_blank">
        <img src="https://www.mysara.cn/images/readme/panel.jpg?v"  alt="Panel">
    </a>
</p>

- If you find `MySara` helpful, please do not hesitate to give us a star.
- Every like from you is the driving force for our continuous improvement.

## Contributors

Thanks to the [Contributors](https://github.com/innocommerce/mysara/graphs/contributors)
